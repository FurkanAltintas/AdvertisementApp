...
namespace AdvertisementApp.UI.Controllers
{
    public class AdvertisementController : Controller
    {
        ...
        {
            var advertisements = await _advertisementAppUserService.GetList(AdvertisementAppUserStatusType.Basvurdu);
        ...
        {
            var userId = await this.UserGender();
        ...
        public async Task<int> UserGender()
        {
